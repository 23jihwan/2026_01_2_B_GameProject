...
public class DialogManager : MonoBehaviour
{
    ...
    [SerializeField] private Image portraitImage;               //캐릭터 초상화 이미 UI 요소 추가
    ...
    {
        dialogPanel.SetActive(false);                               //대화 종료
        currentDialog = null;
    ...
    public void NextDialog()
    {
        ...
        {
            DialogSO nextDialog = dialogDatabase.GetDialongById((int)currentDialog.nextId);
            if (nextDialog != null)
            {
